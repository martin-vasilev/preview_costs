...
load("Experiment 1b/preproc/old_data.Rda")

RegIN <- read.csv("D:/R/preview_costs/Experiment 1b/preproc/RegIN.txt")
RegOUT <- read.csv("D:/R/preview_costs/Experiment 1b/preproc/RegOUT.txt")
...
save(data, file= 'Experiment 1b/data/data.Rda')
write.csv(data, 'Experiment 1b/data/data.csv')
